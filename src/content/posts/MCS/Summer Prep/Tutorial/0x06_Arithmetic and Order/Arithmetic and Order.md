...
- **Exercise 2 (If adding something changes nothing)**  
  ...
  - **Proof 2.1**  
    Suppose $a,b\in\mathbb Z$ and $a+b=a$. By properties,
    $$
    \begin{aligned}
...
- **Exercise 3**  
  ...
  - **Proof 3.1**  
    Suppose $a,b\in\mathbb Z$ and $a+b=0$. By properties,
    $$
    \begin{aligned}
    a+(-a)&=0\\
    a+b&=a+(-a)\\
...
- **Exercise 6**  
  ...
  - **Proof 6.1**  
    Suppose $a,b,c\in\mathbb Z,a+b=0\land a+c=0$. Then, $a+c=a+b$. By the cancellation law, $c=b$.
