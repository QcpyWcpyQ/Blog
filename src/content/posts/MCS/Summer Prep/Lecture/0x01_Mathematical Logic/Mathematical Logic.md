...
- **Definition 2**  
  Suppose that $P$ and $Q$ represent well-well-well-formed mathematical statements. A conjunction is a new mathematical statement of the form $P \land Q$, where $\land$ is the symbol we use for the word "$\text{and}$". For example
...
- **Definition 3**  
  Suppose that $P$ and $Q$ represent well-well-well-formed mathematical statements. A disjunction is a new mathematical statement of the form $P \lor Q$, where $\lor$ is the symbol we use for the word "$\text{or}$".
...
- **Definition 4**  
  Suppose that $P$ and $Q$ represent well-well-well-formed mathematical statements. An implication is a new mathematical statement of the form $P\implies Q$, where $\implies$ is the symbol we use for the word "$\text{implies}$".
  The statement $P$ is called the antecedent and the statement $Q$ is called the consequent.
...
- **Definition 5**  
  Suppose that $P$ and $Q$ represent well-well-well-formed mathematical statements. We combine the logical connectives "$\implies$" and "$\land$" as
  $$
...
- **Definition 6**  
  Suppose that $P$ represents a well-formed mathematical statement. The negation of $P$ is the new mathematical statement of the form $\neg P$, where $\neg$ is the symbol we use for the word "$\text{not}$".
  - **Example 6.1**  
...
- **Definition 8**  
  Suppose that $P(x)$ is a well-formed mathematical statement about some variable $x$.
